 ...
 */
public class HollowBenchmarkTestSuite extends TestSuite {

    private static final int TOTAL_RUNS = 10;
	
    public HollowBenchmarkTestSuite() {
    }

    public HollowBenchmarkTestSuite(final GraphTest graphTest) {
        super(graphTest);
    }

    public void testHollowGraph() throws Exception {
