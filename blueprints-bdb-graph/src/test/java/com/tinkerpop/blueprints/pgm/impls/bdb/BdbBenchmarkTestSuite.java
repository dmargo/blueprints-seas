...
public class BdbBenchmarkTestSuite extends TestSuite {
    ...
    public void testBdbGraph() throws Exception {
        ...
        for (int i = 0; i < TOTAL_RUNS; i++) {
            ...
            BaseTest.printPerformance(graph.toString(), counter, "BDB elements touched", currentTime);
            graph.shutdown();
        }
        BaseTest.printPerformance("BDB", 1, "BDB experiment average", totalTime / (double) TOTAL_RUNS);
    }
